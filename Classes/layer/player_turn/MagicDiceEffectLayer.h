...
#ifndef __SurvivalDungeon__MagicDiceEffectLayer__
#define __SurvivalDungeon__MagicDiceEffectLayer__
...
#endif /* defined(__SurvivalDungeon__MagicDiceEffectLayer__) */
